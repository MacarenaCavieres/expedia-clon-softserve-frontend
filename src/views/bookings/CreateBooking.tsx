                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md space-y-4">
                        ...
                        <div className="text-sm text-gray-700 space-y-1">
                            <p><strong>Room:</strong> {pendingData.roomId}</p>
                            <p><strong>Check-in:</strong> {pendingData.checkInDate}</p>
                            <p><strong>Check-out:</strong> {pendingData.checkOutDate}</p>
                            <p><strong>Guests:</strong> {pendingData.totalGuests}</p>
                            <p><strong>Guest Names:</strong> {pendingData.guestNames}</p>
                        </div>
